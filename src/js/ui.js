export class TranscriptUI {
    ...
    _renderDual() {
        ...
        this.segments.forEach((seg, index) => {
            ...
            this._syncMetaNode(rowNode, showSpeaker ? `Speaker ${seg.speaker}` : '', 'speaker-label');
        ...
        this._syncDualProvisionalNode(lastSpeaker, lastLang);
        this._restoreScroll(scrollHost, scrollState);
    }
    ...
    _renderSingleSegmentNode(node, seg, flags, key) {
        ...
        this._syncMetaNode(node, flags.showSpeaker ? `Speaker ${seg.speaker}` : '', 'speaker-label');
    ...
    _syncSingleProvisionalNode(lastSpeaker, lastLang) {
        ...
        const showSpeaker = !!(this.provisionalSpeaker && this.provisionalSpeaker !== lastSpeaker);
        const showLanguage = !!(this.provisionalLanguage && this.provisionalLanguage !== lastLang);
        this._syncMetaNode(node, showSpeaker ? `Speaker ${this.provisionalSpeaker}` : '', 'speaker-label');
    ...
    _syncDualProvisionalNode(lastSpeaker, lastLang) {
        ...
        const showSpeaker = !!(this.provisionalSpeaker && this.provisionalSpeaker !== lastSpeaker);
        const showLanguage = !!(this.provisionalLanguage && this.provisionalLanguage !== lastLang);
        this._syncMetaNode(rowNode, showSpeaker ? `Speaker ${this.provisionalSpeaker}` : '', 'speaker-label');
    ...
    _cleanupStaleOriginals() {
        ...
        const pending = this.segments.filter((s) => s.status === 'original');
